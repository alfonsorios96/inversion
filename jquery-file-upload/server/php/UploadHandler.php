...
class UploadHandler
{
    ...
    function __construct($options = null, $initialize = true, $error_messages = null) {
        ...
        $this->options = array(
            'script_url' => $this->get_root_url().'/images/inmuebles/'.$exp.'/',
            'upload_dir' => $this->get_relative_url(dirname($this->get_server_var('SCRIPT_FILENAME')), 3).'images/inmuebles/'.$exp.'/',
            'upload_url' => $this->get_root_url().'/images/inmuebles/'.$exp.'/',
            'user_dirs' => false,
            'mkdir_mode' => 0755,
            'param_name' => 'files',
